...
var store = new Category_1.Store();
var CategoryService = /** @class */ (function () {
    function CategoryService() {
        ...
        this.getCategoryById = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        category = _a.sent();
                        if (!category)
                            res.status(200).send({ message: "Theres no category by id ".concat(req.params.id) });
        ...
        this.createCategory = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var newCategory, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, store.create(req.body.name)];
                    case 1:
                        newCategory = _a.sent();
        ...
        this.editCategory = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, store.update({ id: parseInt(req.params.id), name: req.body.name })];
                    case 1:
                        _a.sent();
        ...
        this.deleteCategory = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, store["delete"]({ id: parseInt(req.params.id) })];
                    case 1:
                        _a.sent();
